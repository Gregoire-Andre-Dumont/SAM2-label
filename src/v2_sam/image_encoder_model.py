...
from src.v2_sam.components.hiera_model import HieraModel
from src.v2_sam.components.imgenc_components import HalfStepPatchEmbed, WindowTiledPositionEncoding, OutputProjection
from src.v2_sam.components.shared import Conv1x1Layer
...
class SAMV2ImageEncoder(nn.Module):
    ...
    def prepare_image(
        ...
        scaled_hwc = cv2.resize(image_rgb, dsize=(scaled_w, scaled_h),interpolation=cv2.INTER_CUBIC)
